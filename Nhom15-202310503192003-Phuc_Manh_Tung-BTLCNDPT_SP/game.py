...
game_over_rect = game_over_surface.get_rect(center=(216, 400))
retry_button = pygame.image.load("assests/menu.png").convert_alpha()

# Chỉnh lại kích thước
new_width = 100
new_height = 50
retry_button = pygame.transform.scale(retry_button, (new_width, new_height))

# Lấy hình chữ nhật mới
retry_button_rect = retry_button.get_rect(center=(216, 300))
...
while True:
    ...
    if game_active:
        ...
        # Kiểm tra sự kiện khi người chơi nhấn chuột
